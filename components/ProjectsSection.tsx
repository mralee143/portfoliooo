...
export default function ProjectsSection() {
  ...
  const projects = [
    ...
    },
    {
      ...
      icon: '🏢',
      image: '/assets/full bussines website.jpg',
      side: 'right'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      icon: '🍕',
      image: '/assets/food website.png',
      side: 'left'
    },
    {
      id: 6,
      title: 'Spotify Clone App',
      description: 'Music streaming application with playlist management, search functionality, and audio player controls',
    ...
    },
    {
      ...
      icon: '📄',
      image: '/assets/invoice generated website.png',
      side: 'left'
    }
  ];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Projects Timeline - Center Line with Image Cards */}
          ...
          <div className="relative">
            {projects.map((project, index) => (
              ...
              >
                ...
                {/* Project Card - Full Image with Overlay Content */}
                <motion.div
                  whileHover={{ 
                    scale: 1.05,
                ...
                >
                  ...
                  <motion.div
                    ...
                    whileHover={{ 
                      background: 'linear-gradient(to top, rgba(0,0,0,0.95), rgba(0,0,0,0.60), rgba(0,0,0,0.40))'
                    }}
                    transition={{ duration: 0.3 }}
                  />
                  
                  {/* Project Icon - Top Right */}
                  <motion.div
                    animate={{ 
                      rotate: 360,
                      scale: [1, 1.2, 1]
                    ...
                    className="absolute top-4 right-4 text-2xl bg-red-500/30 backdrop-blur-sm rounded-full p-2 z-20"
                  ...
                  {/* Content Overlay */}
                  <div className="absolute inset-0 p-4 flex flex-col justify-between z-10" style={{ transform: 'translateZ(20px)' }}>
                    ...
                    >
                      <motion.h3 
                        className="text-xl font-bold text-white mb-2 leading-tight drop-shadow-lg"
                        animate={{
                          textShadow: [
                    ...
                    {/* Middle Section - Description (Hidden by default, shown on hover) */}
                    <motion.div
                      initial={{ opacity: 0 }}
                      className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex-1 flex items-center"
                    >
                      <motion.p 
                        className="text-gray-200 text-sm leading-relaxed drop-shadow-lg"
                        style={{ transform: 'translateZ(20px)' }}
                      >
                        {project.description}
                      </motion.p>
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {project.tech.slice(0, 3).map((tech, techIndex) => (
                          <motion.span
                            ...
                            className="px-2 py-1 bg-red-500/30 backdrop-blur-sm text-red-200 text-xs rounded-full border border-red-500/50 transition-all duration-300 drop-shadow-lg"
                        ...
                        {project.tech.length > 3 && (
                          <span className="px-2 py-1 bg-gray-700/50 backdrop-blur-sm text-gray-300 text-xs rounded-full border border-gray-600/50 drop-shadow-lg">
                            +{project.tech.length - 3}
                          </span>
                        )}
                      </div>
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="w-full bg-gradient-to-r from-red-600/90 to-red-700/90 backdrop-blur-sm text-white text-center py-2.5 px-4 rounded-lg text-sm font-bold transition-all duration-300 relative overflow-hidden border border-red-500/30 drop-shadow-lg"
                  ...
                  <motion.div
                    ...
                    style={{
                      background: 'linear-gradient(45deg, rgba(156, 163, 175, 0.3), transparent, rgba(156, 163, 175, 0.3)) border-box'
                    }}
                    animate={{
                      opacity: [0, 0.7, 0]
                    }}
